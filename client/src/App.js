...
const App = () => {
  ...
  useEffect(async () => {
    await axios.get("http://18.220.116.50:8000/chat/api/botmessage-list/").then(
  ...
  const handleClick = async (e) => {
    ...
    if (ref.current.value.length > 0) {
      ...
      setIsLoading(true)
      await axios.post ('http://18.220.116.50:8000/chat/api/botmessage-list/', {value: ref.current.value})
      .then (response => console.log (response))
      
      await axios
        .get("http://18.220.116.50:8000/chat/api/botmessage-list/")
        .then((response) => {
  ...
  const handleFeedback = () => {
    ...
    axios
      .post("http://18.220.116.50:8000/chat/api/message-list/", {
